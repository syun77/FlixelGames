...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "BasementShooter2", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "BasementShooter2";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BasementShooter2", null, { width: 800, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "11",
			company: "HaxeFlixel",
			file: "BasementShooter2",
			fps: 60,
			name: "BasementShooter2",
